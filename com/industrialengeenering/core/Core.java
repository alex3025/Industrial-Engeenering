...
import com.industrialengeenering.client.TextureLiquidsFX;
import com.industrialengeenering.common.SoundHandler;
import com.industrialengeenering.entity.Entities;
import com.industrialengeenering.entity.TileEntityTest;
import com.industrialengeenering.item.Items;
import com.industrialengeenering.liquid.Liquids;
...
@NetworkMod(clientSideRequired=true, serverSideRequired=false, clientPacketHandlerSpec = @SidedPacketHandler (channels = {"ie"}, packetHandler = com.industrialengeenering.client.ClientPacketHandler.class), serverPacketHandlerSpec =@SidedPacketHandler(channels = {"ie"}, packetHandler = com.industrialengeenering.common.ServerPacketHandler.class))
public class Core extends BaseMod {
	...
	public static com.industrialengeenering.common.CommonProxy proxy;
