...
public class RenderTableCatalyticCracker extends TileEntitySpecialRenderer{

	private ModelCatalyticCracker Cracker;
	
	public RenderTableCatalyticCracker() {
		Cracker = new ModelCatalyticCracker();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float var8) {
		...
		if (tileentity.getWorldObj().getBlockId(tileentity.xCoord, tileentity.yCoord,
				tileentity.zCoord) == Blocks.blockCracker.blockID) {
		...
		bindTextureByName("/com/indeng/sprites/CatalyticCracker.png");
