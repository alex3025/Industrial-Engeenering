...
public class GuiReformer extends GuiContainer {
	
	private TileEntityReformer tileEntity;
	
	public GuiReformer(IInventory player, TileEntityReformer chest) {
		super(new ContainerReformer(player, chest));
	...
	protected void drawGuiContainerForegroundLayer(int p1, int p2) {
        this.drawCenteredString(fontRenderer, "Catalyst Reforming Unit", this.xSize/2, 4, 0x404040);
	}
