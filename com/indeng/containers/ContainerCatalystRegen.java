...
public class ContainerCatalystRegen extends Container {
	
	private Slot catalyzer;
	private TileEntityCatalystRegen tile;
	
	public ContainerCatalystRegen(IInventory inventoryplayer, TileEntityCatalystRegen catalystregen) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int fromSlot) {
	    ...
	    if (slot != null && slot.getHasStack()) {
	        ...
	        if(current.itemID != Items.catA.itemID && current.itemID != Items.catB.itemID) {
	        	return null;
	        }
