...
public class ContainerCracking extends Container{
	private Slot catalyzer;
	private TileEntityCracker tile;
	
	public ContainerCracking(IInventory inventoryplayer, TileEntityCracker catalystregen) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int fromSlot) {
	    ...
	    if (slot != null && slot.getHasStack()) {
	        ...
	        if(current.itemID != Items.catA.itemID) {
	        	return null;
	        }
