...
public class TileEntitySteamReformer extends TileEntity  implements ITankContainer {
	...
	public void updateEntity() {
		if(this.bunkerTank.getLiquid() != null && this.steamTank.getLiquid() != null) {
			...
			if(this.steamTank.getLiquid().amount >= 32 && this.bunkerTank.getLiquid().amount > 1000) {
				if(true) {
					...
					this.heatedBunkerTank.fill(LiquidDictionary.getLiquid("Carbon Monoxide", 1000), true);
	...
	public TileEntitySteamReformer(ForgeDirection dir) {
	...
	public TileEntitySteamReformer() {
	...
	public int fill(ForgeDirection from, LiquidStack resource, boolean doFill) {
		...
		if(resource.isLiquidEqual(LiquidDictionary.getLiquid("gasMethane", resource.amount)) && from == this.currentDirection) {
	...
	public LiquidStack drain(ForgeDirection from, int maxDrain, boolean doDrain) {
		...
		} else if (from == this.hydroDirection) {
			return this.hydroTank.drain(maxDrain, doDrain);
		}
