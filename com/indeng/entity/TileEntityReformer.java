...
public class TileEntityReformer extends TileEntity implements ITankContainer, IInventory {
	...
	public void updateEntity() {
		if(this.bunkerTank.getLiquid() != null && this.steamTank.getLiquid() != null) {
			...
			if(this.steamTank.getLiquid().amount >= 32 && this.bunkerTank.getLiquid().amount > 0 && this.inv[0] != null) {
				if(this.inv[0].getItemDamage() < this.inv[0].getItem().getMaxDamage() && this.inv[0].itemID == Items.catB.itemID) {
	...
	public TileEntityReformer(ForgeDirection dir) {
	...
	public int fill(ForgeDirection from, LiquidStack resource, boolean doFill) {
		...
		if(resource.isLiquidEqual(LiquidDictionary.getLiquid("Gasoline", resource.amount)) && from == this.currentDirection || resource.isLiquidEqual(LiquidDictionary.getLiquid("Kerosene", resource.amount))) {
